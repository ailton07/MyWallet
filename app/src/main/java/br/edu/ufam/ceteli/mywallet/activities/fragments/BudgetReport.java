...
public class BudgetReport extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        recyclerView.setPadding(recyclerView.getPaddingLeft(), (int) ((104 + 116) * getResources().getDisplayMetrics().density + 0.5f), recyclerView.getPaddingRight(), recyclerView.getPaddingBottom());
        recyclerView.addItemDecoration(new DividerItemDecoration(getContext(), DividerItemDecoration.VERTICAL_LIST));
        recyclerView.setAdapter(new RecyclerViewBudgetAdapter(Entry.getGeralOrcamento()));
        recyclerView.addOnScrollListener(RecyclerScrollListener.getInstance(appBarLayout, (int) (116 * getResources().getDisplayMetrics().density + 0.5f)));
        return recyclerView;
    }
}
